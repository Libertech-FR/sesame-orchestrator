...
dbs: ## Run dependencies for development
	...
	@docker compose --project-directory docker up -d $(APPNAME)-redis $(APPNAME)-mongo

stop: ## Stop all containers
	@docker compose --project-directory docker down --remove-orphans
	@docker compose --project-directory docker rm -f
