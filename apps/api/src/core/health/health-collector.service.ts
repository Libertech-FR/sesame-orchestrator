...
const parsedHealthCollectionIntervalMs = Number.parseInt(
  `${process.env.SESAME_HEALTH_COLLECTION_INTERVAL_MS || ''}`,
  10,
);
const HEALTH_COLLECTION_INTERVAL_MS =
  Number.isFinite(parsedHealthCollectionIntervalMs) && parsedHealthCollectionIntervalMs > 0
