...
q-dialog(
  ...
  q-card.q-dialog-plugin
    q-card-section
      .text-h6 Mettre à jour les identités
    q-card-section
      p {{ mainText }}
      q-checkbox(
...
const mainText = computed(
  () => `Vous êtes sur le point d envoyer une invitation à ${props.selectedIdentities.length} identités "${props.identityTypesName}". Voulez-vous continuer ?`,
)
