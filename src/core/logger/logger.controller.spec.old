...
describe('LoggerController', () => {
  ...
  describe('search', () => {
    it('should return an array of Logger objects and the total count', async () => {
      const req = getMockReq()
      const query = { _id: _id.toString() }
      const limit = 10
      const skip = 1
      const expectedResult: [Logger[], number] = [[object], 1]
    ...
    it('should return an array of Logger objects with default pagination', async () => {
      const req = getMockReq()
      const query = { _id: _id.toString() }
      const limit = 0
      const skip = 0
  ...
  describe('read', () => {
    it('should return the data successfully', async () => {
      const expectedResult: Logger = object
  ...
  describe('create', () => {
    it('should return a Logger object', async () => {
      const dto: LoggerDto = { someProp: 'value' }
